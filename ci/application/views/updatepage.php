...
<br>
 <!--<form method="get" id="updatenameform" name="updatenameform" action="" role="form"> -->
  ...
  $info=array('id'=>'updatenameform',
            ...
            echo form_open_multipart('Data/changenamee',$info);
            ?>
         <?php   $csrf = array(
...
<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
  ...
  $info=array('id'=>'updateemailform',
            ...
            echo form_open_multipart('Data/changeemail',$info);
            ?>
         <?php   $csrf = array(
        'name' => $this->security->get_csrf_token_name(),
        'hash' => $this->security->get_csrf_hash()
...
<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
  ...
  $info=array('id'=>'updatephoneform',
            ...
            echo form_open_multipart('Data/changephone',$info);
            ?>
         <?php   $csrf = array(
        'name' => $this->security->get_csrf_token_name(),
        'hash' => $this->security->get_csrf_hash()
...
<hr>
  ...
  $info=array('id'=>'uploadimage',
            ...
            echo form_open_multipart('Data/changeimage',$info);
            ?>
         <?php   $csrf = array(
        'name' => $this->security->get_csrf_token_name(),
        'hash' => $this->security->get_csrf_hash()
